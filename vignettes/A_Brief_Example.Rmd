...
To obtain a key, register for a ***"my ncbi account"*** (*https://www.ncbi.nlm.nih.gov/account/*)
and generate one from the ***"account settings page"*** (*https://www.ncbi.nlm.nih.gov/account/settings/*).
